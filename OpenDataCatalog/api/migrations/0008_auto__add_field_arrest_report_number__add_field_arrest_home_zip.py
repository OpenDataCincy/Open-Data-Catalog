...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Arrest.report_number'
        db.add_column(u'api_arrest', 'report_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Arrest.home_zip'
        db.add_column(u'api_arrest', 'home_zip',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Arrest.report_number'
        db.delete_column(u'api_arrest', 'report_number')

        # Deleting field 'Arrest.home_zip'
        db.delete_column(u'api_arrest', 'home_zip')

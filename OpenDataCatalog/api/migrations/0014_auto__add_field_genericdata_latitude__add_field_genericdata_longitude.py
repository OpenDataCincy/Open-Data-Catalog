...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericData.latitude'
        db.add_column(u'api_genericdata', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'GenericData.longitude'
        db.add_column(u'api_genericdata', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericData.latitude'
        db.delete_column(u'api_genericdata', 'latitude')

        # Deleting field 'GenericData.longitude'
        db.delete_column(u'api_genericdata', 'longitude')

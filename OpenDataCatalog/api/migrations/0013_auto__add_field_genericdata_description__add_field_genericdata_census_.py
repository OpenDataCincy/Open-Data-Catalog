...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericData.description'
        db.add_column(u'api_genericdata', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'GenericData.census_tract'
        db.add_column(u'api_genericdata', 'census_tract',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.request_type'
        db.add_column(u'api_genericdata', 'request_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.csr'
        db.add_column(u'api_genericdata', 'csr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.status'
        db.add_column(u'api_genericdata', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericData.description'
        db.delete_column(u'api_genericdata', 'description')

        # Deleting field 'GenericData.census_tract'
        db.delete_column(u'api_genericdata', 'census_tract')

        # Deleting field 'GenericData.request_type'
        db.delete_column(u'api_genericdata', 'request_type')

        # Deleting field 'GenericData.csr'
        db.delete_column(u'api_genericdata', 'csr')

        # Deleting field 'GenericData.status'
        db.delete_column(u'api_genericdata', 'status')

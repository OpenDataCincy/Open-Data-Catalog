...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Arrest.home_address'
        db.alter_column(u'api_arrest', 'home_address', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Arrest.arrest_address'
        db.alter_column(u'api_arrest', 'arrest_address', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Arrest.home_address'
        db.alter_column(u'api_arrest', 'home_address', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Arrest.arrest_address'
        db.alter_column(u'api_arrest', 'arrest_address', self.gf('django.db.models.fields.CharField')(max_length=30))

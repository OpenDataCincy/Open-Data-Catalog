...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericData.comp_type'
        db.add_column(u'api_genericdata', 'comp_type',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.sub_type'
        db.add_column(u'api_genericdata', 'sub_type',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericData.comp_type'
        db.delete_column(u'api_genericdata', 'comp_type')

        # Deleting field 'GenericData.sub_type'
        db.delete_column(u'api_genericdata', 'sub_type')

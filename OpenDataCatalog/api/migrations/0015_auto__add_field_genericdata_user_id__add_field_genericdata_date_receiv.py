...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericData.user_id'
        db.add_column(u'api_genericdata', 'user_id',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.date_received'
        db.add_column(u'api_genericdata', 'date_received',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.time_received'
        db.add_column(u'api_genericdata', 'time_received',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GenericData.date_planned_completion'
        db.add_column(u'api_genericdata', 'date_planned_completion',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericData.user_id'
        db.delete_column(u'api_genericdata', 'user_id')

        # Deleting field 'GenericData.date_received'
        db.delete_column(u'api_genericdata', 'date_received')

        # Deleting field 'GenericData.time_received'
        db.delete_column(u'api_genericdata', 'time_received')

        # Deleting field 'GenericData.date_planned_completion'
        db.delete_column(u'api_genericdata', 'date_planned_completion')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericData'
        db.create_table(u'api_genericdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('community', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True)),
            ('anon_location', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True)),
            ('anon_address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True)),
            ('street_direction', self.gf('django.db.models.fields.CharField')(default=u'', max_length=2, blank=True)),
            ('x_coordinate', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('y_coordinate', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('parcel', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('approved', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
        ))
        db.send_create_signal(u'api', ['GenericData'])


    def backwards(self, orm):
        # Deleting model 'GenericData'
        db.delete_table(u'api_genericdata')

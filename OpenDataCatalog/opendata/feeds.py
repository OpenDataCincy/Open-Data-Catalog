...
class ResourcesFeed(BaseResourceFeed):
    title = "OpenDataCincy.org: Resources - All"
    link = "/feeds/resources/"
    description = "List of resources on OpenDataCincy.org listed in the order they were added"
...
class UpdatesFeed(BaseResourceFeed):
    title = "OpenDataCincy.org: Resources - Last Updated"
    link = "/feeds/updates/"
    description = "List of resources on OpenDataCincy.org listed in the order they were last updated"
    description_template = "feeds/resource.html"
    feed_type = Rss2
...
class IdeasFeed(Feed):
    title = "OpenDataCincy.org: Ideas"
    link = "/feeds/ideas/"
    description = "List of ideas on OpenDataCincy.org listed in the order they were added"
...
class TagFeed(BaseResourceFeed):
    ...
    def title(self, obj):
        return "OpenDataCincy.org: Resources in %s" % obj.tag_name

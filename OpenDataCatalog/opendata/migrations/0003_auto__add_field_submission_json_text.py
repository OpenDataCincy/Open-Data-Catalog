...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.json_text'
        db.add_column(u'opendata_submission', 'json_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.json_text'
        db.delete_column(u'opendata_submission', 'json_text')

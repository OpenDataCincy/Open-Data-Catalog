...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Url.url'
        db.alter_column(u'opendata_url', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Url.url'
        db.alter_column(u'opendata_url', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'opendata.idea': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'idea_created_by'", 'to': u"orm['auth.User']"}),
            'created_by_date': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['opendata.Resource']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'idea_updated_by'", 'to': u"orm['auth.User']"}),
            'updated_by_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'opendata.ideaimage': {
            'Meta': {'object_name': 'IdeaImage'},
            'home_page': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idea': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opendata.Idea']"}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'source_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'opendata.odpuserprofile': {
        ...
        u'opendata.submission': {
            'Meta': {'object_name': 'Submission'},
            'email_text': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'opendata.url': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opendata.Resource']"}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '255'}),
            'url_label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'url_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opendata.UrlType']"})
        },
        u'opendata.urlimage': {
            ...
            'source_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'url': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['opendata.Url']"})
        },
        u'opendata.urltype': {

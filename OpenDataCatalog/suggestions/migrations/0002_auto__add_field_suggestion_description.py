...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.description'
        db.add_column(u'suggestions_suggestion', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.description'
        db.delete_column(u'suggestions_suggestion', 'description')
